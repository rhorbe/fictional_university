...
function followandrew_register_styles()
{
  ...
  wp_enqueue_style('followandrew-style', get_template_directory_uri() . "/assets/css/style.css", array('followandrew-bootstrap'), $version, 'all');
  wp_enqueue_style('followandrew-bootstrap', 'https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css', array(), '', 'all');
...
function followandrew_register_scripts()
{
  ...
  wp_enqueue_script('followandrew-style', get_template_directory_uri() . "/assets/js/main.js", array(), $version, true);
}
...
add_action('init', 'followandrew_widget_areas');