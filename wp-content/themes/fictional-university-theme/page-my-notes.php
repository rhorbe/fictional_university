...
?>
    ...
    <div class="container container--narrow page-section">
        ...
        <div class="create-note">
            ...
            <textarea placeholder="Your note here..." cols="30" rows="10" class="new-note-body"></textarea>
        ...
        <ul class="min-list link-list" id="my-notes">
            ...
            ?>
                <li data-id="<?php the_ID() ?>">
                    <input readonly class="note-title-field" value="<?php echo str_replace('Privado: ', '', esc_attr(get_the_title())); ?>">
