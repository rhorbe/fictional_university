...
<meta name="charset=" <?php bloginfo('charset') ?>">
        ...
        <div class="container">
            ...
            <div class="site-header__menu group">
                <nav class="main-navigation">
                    <!-- Esta es la forma de utilizar menús dinámicos. No se utilizan en este ejercicio-->
                    <!-- <?php // wp_nav_menu(array( 'theme_location' => 'headerMenuLocation' ));
                            ?> -->
                    <ul>
                        <!-- // TODO este código es horrible -->
                        <li <?php
                            if (is_page('acerca-de') or wp_get_post_parent_id(0)) {
                                echo 'class="current-menu-item"';
                            } ?>>
                            <a href="<?php echo site_url('/acerca-de/'); ?>">About Us</a>
                        </li>
                        <li <?php
